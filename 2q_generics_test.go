...
func Benchmark2QG_Rand(b *testing.B) {
	l, err := New2QG[int64, int64](8192)
	if err != nil {
		b.Fatalf("err: %v", err)
	}
...
func Benchmark2QG_Freq(b *testing.B) {
	l, err := New2QG[int64, int64](8192)
	if err != nil {
		b.Fatalf("err: %v", err)
	}
...
func Test2QG_RandomOps(t *testing.T) {
	size := 128
	l, err := New2QG[int64, int64](128)
	if err != nil {
		t.Fatalf("err: %v", err)
	}
...
func Test2QG_Get_RecentToFrequent(t *testing.T) {
...
func Test2QG_Add_RecentToFrequent(t *testing.T) {
	l, err := New2QG[int, int](128)
	if err != nil {
		t.Fatalf("err: %v", err)
	}
...
func Test2QG_Add_RecentEvict(t *testing.T) {
...
func Test2QG_Contains(t *testing.T) {
