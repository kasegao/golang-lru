...
func BenchmarkARCG_Rand(b *testing.B) {
	l, err := NewARCG[int64, int64](8192)
	if err != nil {
		b.Fatalf("err: %v", err)
	}
...
func BenchmarkARCG_Freq(b *testing.B) {
	l, err := NewARCG[int64, int64](8192)
	if err != nil {
		b.Fatalf("err: %v", err)
	}
...
func TestARCG_RandomOps(t *testing.T) {
	size := 128
	l, err := NewARCG[int64, int64](128)
	if err != nil {
		t.Fatalf("err: %v", err)
	}
...
func TestARCG_Get_RecentToFrequent(t *testing.T) {
...
func TestARCG_Adaptive(t *testing.T) {
